...
private:
    ...
    void peak() {
        ...
        while (true) {
            ...
            b.Project(test_proj_map, 1, true);
...
void parseHelper(EnglishParserBrain& b, std::string sentence, int project_rounds, 
    ...
    std::function<void(const std::string&, const std::map<std::string, std::set<std::string>>&)> read_out;
    ...
    std::cout << "everything will be allright" << std::endl;
}
